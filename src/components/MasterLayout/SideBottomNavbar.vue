...
<template>
  <ul class="space-y-1">
    <li>
      <RouterLink
        to="/setting"
        class="text-neutral-400 flex items-center gap-2 font-light px-3 py-2 hover:bg-neutral-700 hover:no-underline rounded-sm text-base"
      >
        <svg
          stroke="currentColor"
          fill="currentColor"
    ...
    <li>
      <RouterLink
        to="/help-support"
        class="text-neutral-400 flex items-center gap-2 font-light px-3 py-2 hover:bg-neutral-700 hover:no-underline active:bg-neutral-600 rounded-sm text-base"
      >
        <svg
          stroke="currentColor"
          fill="currentColor"
    ...
    <li
      class="text-red-400 flex items-center gap-2 font-light px-3 py-2 hover:bg-neutral-700 hover:no-underline active:bg-neutral-600 rounded-sm text-base cursor-pointer"
    >
      <svg
        stroke="currentColor"
        fill="currentColor"
